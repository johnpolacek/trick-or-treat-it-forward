...
// you can inline your Firebase config or set environment variables howevever
...
const dotEnvFiles = [
  `${dotEnvPath}.${NODE_ENV}.build`,
  `${dotEnvPath}.${NODE_ENV}`,
  // Don't include `.env.build` for the test environment.
  NODE_ENV !== "test" && `${dotEnvPath}.build`,
  dotEnvPath,
].filter(Boolean)
